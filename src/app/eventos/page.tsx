    ...
    <div>
      ...
      <div className=' flex flex-col justify-center items-center gap-0 '>
        <Basecard imagen={'/mascotas.png'} title={'mascotas'} >
          ...
          <SmallText text={'Celebra el amor por nuestros peludos amigos con una jornada llena de diversión, juegos y premios para tus mascotas. Habrá concursos, fotos especiales, consejos de cuidado y mucho más. ¡Trae a tu compañero de cuatro patas y disfruten juntos de este día inolvidable!'} />
          <div className='font-black text-center mt-4'>
            <SmallText text={'¡TODO EL DIA! SABADO 25 Y DOMINGO 26  Porque ellos son parte de la familia!'} />
          </div>
        </Basecard >
      </div>
