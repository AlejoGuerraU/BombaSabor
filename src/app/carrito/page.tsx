      ...
      <div className="flex flex-row">
        ...
        <div className="flex flex-row gap-5 m-5 h-40 border-2 items-center border-gray-400 shadow-md">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-row gap-2 items-center">
                <button className="bg-bank2 h-10 w-22 rounded-2xl cursor-pointer"><p className="text-white">Eliminar</p></button>
        ...
        <div className="border-2 m-5 rounded-2xl">
          ...
          <div className="flex justify-center">
            <button className="w-30 h-10 bg-bank6 rounded-3xl m-4 cursor-pointer"><p>Pagar</p></button>
          </div>
        </div>
        </div>
      </div>
